...
@Composable
fun StockEntryScreen(vm: com.inventrack.ui.stock.StockViewModel = hiltViewModel()) {
    var productId by remember { mutableStateOf("") }
    var qty by remember { mutableStateOf("") }
    Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
        Text("Stock Entry", style = MaterialTheme.typography.headlineLarge)
        ...
        Button(onClick = {
            ...
            vm.entry(pid, q, null, null) { res -> /* handle result */ }
        }, modifier = Modifier.fillMaxWidth()) { Text("Register Entry") }
    }
}
